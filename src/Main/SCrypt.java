...
public class SCrypt {
     ...
     */
    public static byte[] scrypt(char[] password, String salt, int N, int r, int p, int dkLen) throws GeneralSecurityException, UnsupportedEncodingException {
    	byte[] encrypted = SCrypt.scryptJ(Util.toBytes(password), salt.getBytes("UTF-8"), N, r, p, dkLen);
    	return encrypted;
    }
